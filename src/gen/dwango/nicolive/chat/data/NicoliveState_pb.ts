...
export const file_dwango_nicolive_chat_data_NicoliveState: GenFile = /*@__PURE__*/
  fileDesc("", [file_dwango_nicolive_chat_data_Statistics, file_dwango_nicolive_chat_data_Enquete, file_dwango_nicolive_chat_data_MoveOrder, file_dwango_nicolive_chat_data_Marque, file_dwango_nicolive_chat_data_CommentLock, file_dwango_nicolive_chat_data_CommentMode, file_dwango_nicolive_chat_data_TrialPanel, file_dwango_nicolive_chat_data_FingerPrint, file_dwango_nicolive_chat_data_ProgramStatus, file_dwango_nicolive_chat_data_atoms_ModerationAnnouncement]);
...
export type NicoliveState = Message<"dwango.nicolive.chat.data.NicoliveState"> & {
  /**
   * @generated from field: dwango.nicolive.chat.data.Statistics statistics = 1;
   */
  statistics?: Statistics;

  /**
   * @generated from field: dwango.nicolive.chat.data.Enquete enquete = 2;
   */
  enquete?: Enquete;

  /**
   * @generated from field: dwango.nicolive.chat.data.MoveOrder move_order = 3;
   */
  moveOrder?: MoveOrder;

  /**
   * @generated from field: dwango.nicolive.chat.data.Marque marque = 4;
   */
  marque?: Marque;

  /**
   * @generated from field: dwango.nicolive.chat.data.CommentLock comment_lock = 5;
   */
  commentLock?: CommentLock;

  /**
   * @generated from field: dwango.nicolive.chat.data.CommentMode comment_mode = 6;
   */
  commentMode?: CommentMode;

  /**
   * @generated from field: dwango.nicolive.chat.data.TrialPanel trial_panel = 7;
   */
  trialPanel?: TrialPanel;

  /**
   * @generated from field: dwango.nicolive.chat.data.FingerPrint finger_print = 8;
   */
  fingerPrint?: FingerPrint;

  /**
   * @generated from field: dwango.nicolive.chat.data.ProgramStatus program_status = 9;
   */
  programStatus?: ProgramStatus;

  /**
   * @generated from field: dwango.nicolive.chat.data.atoms.ModerationAnnouncement moderation_announcement = 10;
   */
